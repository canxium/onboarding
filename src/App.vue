...
import ledgerModule from '@web3-onboard/canxium'

const metamaskSDKWallet = metamaskSDK({options: {
  extensionOnly: false,
  dappMetadata: {
    name: 'Canxium Onboard'
  }
}})

const wcInitOptions = {
  projectId: 'ceec87ffab5d27a35fc8326c6770a2c3',
  requiredChains: [3003],
}

const ledger = ledgerModule(wcInitOptions)
const walletConnect = walletConnectModule(wcInitOptions)
const injected = injectedModule()
const rpcUrl = `https://rpc.canxium.org`
const option = {
  showSidebar: true,
  disableClose: false,
  autoConnectLastWallet: true,
  autoConnectAllPreviousWallet: false,
  iDontHaveAWalletLink: 'https://play.google.com/store/apps/details?id=com.canxium.mobile',
  removeWhereIsMyWalletWarning: true,
}

init({
  wallets: [walletConnect, ledger, metamaskSDKWallet],
  chains: [
    {
      id: '0xbbb',
      token: 'CAU',
      label: 'Canxium Mainnet',
      rpcUrl
    }
  ],
  connect: option,
...
<style type="text/css">
	.st0{fill:#0E101D !important;}
	.st1{fill:url(#SVGID_1_) !important;}
...
<g id="Logo">
	<g>
		<linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="587.3316" y1="499.9986" x2="719.9994" y2="499.9986">
			<stop  offset="0" style="stop-color:#7C37F5 !important"/>
			<stop  offset="1" style="stop-color:#BE41EB !important"/>
		</linearGradient>
...
<template>
  <header>
    ...
    <div class="wrapper">
      <HelloWorld msg="Canxium Onboarding" />

      <nav>
        <a target="_blank" href="https://canxium.org">Home</a>
        <a target="_blank" href="https://www.youtube.com/playlist?list=PLKFSnTfRX9irDYUsog2QvL3XeGAl1QCQG">How To</a>
        <a target="_blank" href="https://play.google.com/store/apps/details?id=com.canxium.mobile">Canxium Wallet</a>
      </nav>
    </div>
  </header>
